...
# Case study 1: clean google analytics customer data

This data comes from a [Kaggle dataset](https://www.kaggle.com/c/ga-customer-revenue-prediction/data?select=test.csv). I read in only the top 100 rows and relevant json columns.
