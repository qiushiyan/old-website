...
df <- tibble(x = c(297677339, 5904868401),
             y = c(0.00000000065, 0.0000000003),
             label = c("Average amount of the most common debt category",
...
p + 
  ...
  ggrepel::geom_text_repel(aes(x = x, y = y, label = label), data = df)
```
...
Finally, let's make a plot again to show the top 20 countries with highest debt, as in table \@ref(tab:countries-with-highest-debt), plus the specific category in which they take highest debt in.
