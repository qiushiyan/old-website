...
penguins_grouped %>% 
  summarize(across(matches("mm"), 
                   ...
                   .names = "{fn}_{col}"))
#> # A tibble: 3 x 7
#>   species   min_culmen_lengt~ max_culmen_leng~ min_culmen_dept~ max_culmen_dept~
#>   <chr>                 <dbl>            <dbl>            <dbl>            <dbl>
...
#> 6 Gentoo    culmen_depth_mm    2.02      0.219      9.24 1.02e-15
```
...
## Use `summarize` in non-summary context
...
New verb `relocate` is provided to change column positions with the same syntax as `select`. The default behaviour is to move selected columns to the left-hand side
...
#> # ... with 334 more rows, and 2 more variables: body_mass_g <dbl>, sex <chr>
```
...
#>  2 Adelie    Torgersen             36.7            18.8              187        3800
#>  3 Chinstrap Dream                 49.5            19                200        3800
#>  4 Adelie    Biscoe                45.6            20.3              191        4600
#>  5 Chinstrap Dream                 46.6            17.8              193        3800
#>  6 Chinstrap Dream                 42.5            17.3              187        3350
#>  7 Adelie    Biscoe                37.7            18.7              180        3600
#>  8 Gentoo    Biscoe                46.8            14.3              215        4850
#>  9 Adelie    Torgersen             41.1            17.6              182        3200
#> 10 Gentoo    Biscoe                48.5            14.1              220        5300
#> # ... with 1 more variable: sex <chr>
...
``` r
penguins %>% summarize(across(starts_with("culmen"), ~ sum(is.na(.x))))
#> # A tibble: 1 x 2
