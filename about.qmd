...
I work mostly in R and sometimes in Python for data science. Here is some selected proejcts.
...
- miscellaneous
  ...
  - [clipstash](https://github.com/qiushiyan/clipstash): A web app and cli written in rust to take notes and retrieve to clipboard
