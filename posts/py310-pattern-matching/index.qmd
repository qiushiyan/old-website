...
categories: Python
description: |
    The biggest incentive to upgrade my python version
knitr: true
image: featured.png
---
...
Note: the first line of the error message `"Error in py_call_impl(...)"` in this example are not from python, because this post is rendered with a python wrapper in R.
