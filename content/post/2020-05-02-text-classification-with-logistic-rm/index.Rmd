...
There are `r nrow(count(tidy_books, word))` and features (words) and `r nrow(count(tidy_books, line_index))` observations in total. Approximately 18% fo the response are 1 (Emily Brontë).
